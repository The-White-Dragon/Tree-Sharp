...
public class TreeTests
{
    ...
    {
        Assert.That(Tree.Parse(input)[path].Count, Is.EqualTo(expectedLength));
    }
    ...
    {
        Assert.That(Tree.Parse(input)[path].ToString(), Is.EqualTo(expectedNode));
    }
    ...
    {
        Assert.That(Tree.Parse(input)[path].Value, Is.EqualTo(expectedValue));
    }
    ...
    [TestCase("1 1_v\n\t1.1 1.1_v\n\t\t1.1.1 1.1.1_v\n\n\t\n\t1.2 1.2_v\n\t1.3 1.3_v\n\t\t1.3.1 1.3.1_v\n\t\t1.3.2 1.3.2_v\n2 2.v\n\t2.1 2.1v",
              "1 1_v\n\t1.1 1.1_v\n\t\t1.1.1 1.1.1_v\n\t1.2 1.2_v\n\t1.3 1.3_v\n\t\t1.3.1 1.3.1_v\n\t\t1.3.2 1.3.2_v\n2 2.v\n\t2.1 2.1v")]
    public void ParseWithNonZeroLevelOnTheEnd_Success(string input, string expected)
    {
        Assert.That(Tree.Parse(input).ToString(), Is.EqualTo(expected));
    }
}
